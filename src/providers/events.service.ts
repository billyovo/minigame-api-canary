...
export class EventsService {
    ...
    async generateBanner() {
        const nearestEvent = Array.from(this.eventSchedule.values()).sort((a, b) => a.nextOccurrence.getTime() - b.nextOccurrence.getTime())[0];
        this.makeBanner(nearestEvent.title, nearestEvent.nextOccurrence.toISOString().substring(0,10));
    }
